...
const LoginWithProvider: FC<LoginWithProviderProps> = () => (
  <div className={styles.LoginWithProvider} data-testid="LoginWithProvider">
    <button className={styles.logoButton}><img className={styles.logo} src='https://upload.wikimedia.org/wikipedia/commons/5/53/Google_%22G%22_Logo.svg' alt='google'/></button>
